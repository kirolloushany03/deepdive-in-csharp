...
//// Read the whole line from input
...
//long longValue = long.Parse(parts[1]);
//char charValue = char.Parse(parts[2]);
//double doubleValue1 = double.Parse(parts[3]);
//double doubleValue2 = double.Parse(parts[4]);
...
//Console.WriteLine($"{doubleValue2:F1}");
...
//if(IsInrange(n, Min, Max) && IsInrange(x, Min, Max)&& IsInrange(y, Min, Max))
//    Console.WriteLine((y - x) * n);
